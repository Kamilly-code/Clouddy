...
interface PomodoroApiService {
    @GET("/pomodoros")
    suspend fun getPomodoroSettings(): Response<PomodoroResponseDto>

    @POST("/pomodoros")
    suspend fun insertPomodoro(@Body request: PomodoroRequestDto): PomodoroResponseDto
    ...
    @DELETE("/pomodoros")
    suspend fun deleteAllPomodoros(): String
